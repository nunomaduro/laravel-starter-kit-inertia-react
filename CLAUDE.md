...
- `health-development` — Spatie Laravel Health: scheduled checks, `health:check`, `HealthServiceProvider`, `config/health.php`, result history, notifications. Activates when adding or tuning health checks, scheduling, or troubleshooting failed checks.
