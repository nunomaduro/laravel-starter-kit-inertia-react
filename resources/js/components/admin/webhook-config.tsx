...
function WebhookConfig({
    ...
    const [testResult, setTestResult] =
        React.useState<WebhookDeliveryStatus | null>(lastDelivery ?? null);
        ...
        <div className={cn('space-y-4', className)}>
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        We will send POST requests to this URL when selected
                        events occur.
                    </CardDescription>
                </CardHeader>
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-2">
                            <Badge variant="secondary" className="text-xs">
                                {localValue.events.length}/{events.length}{' '}
                                selected
                            </Badge>
                            <Button
                                variant="ghost"
                                ...
                                <div className="space-y-2">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <Label
                                            ...
                                            className="cursor-pointer text-sm font-semibold tracking-wider text-muted-foreground uppercase"
                                        >
                                            {resource}
                                        </Label>
                                    </div>
                                    <div className="ml-6 space-y-2">
                                        {resourceEvents.map((event) => (
                                            ...
                                            >
                                                <Checkbox
                                                    id={event.id}
                                                    checked={localValue.events.includes(
                                                        event.id,
                                                    )}
                                                    onCheckedChange={() =>
