<x-filament-widgets::widget>
    <x-filament::section>
        ...
        <ul class="list-disc list-inside space-y-1 text-sm text-gray-600 dark:text-gray-400">
            <li>If you used <strong>Express install</strong>: change the default admin password (<code class="rounded bg-gray-100 dark:bg-gray-800 px-1 py-0.5">admin@example.com</code>) in your profile or User Management.</li>
